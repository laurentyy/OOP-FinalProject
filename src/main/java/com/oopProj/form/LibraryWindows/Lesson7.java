...
public class Lesson7 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        PDFbutton.setBackground(new java.awt.Color(86, 84, 198));
        ...
        PDFbutton.setText("Learn about Transistor Small Signal Amplifiers!");
        ...
        jLabel1.setText("Transistor Small");
        jLabel1.setIconTextGap(10);

        jPanel2.setBackground(new java.awt.Color(236, 234, 248));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/libraryIcons/8.png"))); // NOI18N
        ...
        jLabel3.setText("Discover the complex world of transistor small signal amplifiers as you");

        jLabel4.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(0, 0, 0));
        jLabel4.setText("set out to understand the fundamental ideas and working details of");

        jLabel5.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 0, 0));
        jLabel5.setText("these devices. Discover the intricacies of load-line analysis and acquire a");

        jLabel6.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(0, 0, 0));
        jLabel6.setText("networks that are series, parallel, and series-parallel. Set off on an");

        jLabel7.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(0, 0, 0));
        jLabel7.setText("familiar with analog circuits and learn how to analyze transistor");

        jLabel8.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(0, 0, 0));
        jLabel8.setText("deep comprehension of its utilization in transistor circuits. Become");

        jLabel9.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(0, 0, 0));
        jLabel9.setText("educational journey where every course reveals the intricate inner");

        jLabel10.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(0, 0, 0));
        jLabel10.setText("workings of these essential parts of contemporary electronic systems.");

        jLabel12.setFont(new java.awt.Font("Istok Web", 1, 24)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(0, 0, 0));
        jLabel12.setText("Signal Amplifiers");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(99, 99, 99)
                .addComponent(PDFbutton, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(67, 67, 67))
        );
    ...
    private void PDFbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PDFbuttonActionPerformed
        ...
        try{
            File file = new File("src/main/java/Library_PDFfiles/Lesson7.pdf");
            if(file.exists()){
