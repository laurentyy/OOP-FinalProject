...
public class Lesson13 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        PDFbutton.setBackground(new java.awt.Color(46, 129, 184));
        ...
        PDFbutton.setText("Learn about DACs and ADCs!");
        ...
        jLabel1.setText("Digital to Analog and");
        jLabel1.setIconTextGap(10);

        jPanel2.setBackground(new java.awt.Color(236, 234, 248));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/libraryIcons/14.png"))); // NOI18N
        ...
        jLabel3.setText("Step out to learning Digital to Analog and Analog to Digital Converters");

        jLabel4.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(0, 0, 0));
        jLabel4.setText("(DACs and ADCs), where analog and digital media coexist harmoniously. ");

        jLabel5.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 0, 0));
        jLabel5.setText("Discover the fundamentals of conversion, from accurately converting");

        jLabel6.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(0, 0, 0));
        jLabel6.setText("architectures as you delve into their subtleties. Observe their crucial");

        jLabel7.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(0, 0, 0));
        jLabel7.setText("Discover the workings and performance traits of DAC and ADC");

        jLabel8.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(0, 0, 0));
        jLabel8.setText("digital data into analog outputs to precisely digitizing analog signals. ");

        jLabel9.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(0, 0, 0));
        jLabel9.setText("functions in a range of applications, such as data collecting and audio");

        jLabel10.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(0, 0, 0));
        jLabel10.setText("processing, among others. By bridging the digital and analog realms with");

        jLabel12.setFont(new java.awt.Font("Istok Web", 1, 24)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(0, 0, 0));
        jLabel12.setText("Analog to Digital Converters");
        ...
        jLabel13.setText("DACs and ADCs, you can open up a world of possibilities in contemporary");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(PDFbutton, javax.swing.GroupLayout.PREFERRED_SIZE, 285, javax.swing.GroupLayout.PREFERRED_SIZE)))))
    ...
    private void PDFbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PDFbuttonActionPerformed
        ...
        try{
            File file = new File("src/main/java/Library_PDFfiles/Lesson13.pdf");
            if(file.exists()){
