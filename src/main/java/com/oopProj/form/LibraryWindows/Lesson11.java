...
public class Lesson11 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        PDFbutton.setBackground(new java.awt.Color(106, 84, 198));
        ...
        PDFbutton.setText("Learn about Active Filters!");
        ...
        jLabel1.setText("Active Filters");
        jLabel1.setIconTextGap(10);

        jPanel2.setBackground(new java.awt.Color(236, 234, 248));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/libraryIcons/12.png"))); // NOI18N
        ...
        jLabel3.setText("Enter the emerging field of active filters, where signal processing is");

        jLabel4.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(0, 0, 0));
        jLabel4.setText("revolutionized by the interaction of active components. Examine their");

        jLabel5.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 0, 0));
        jLabel5.setText("flexible uses, which range from improving signal quality to modifying");

        jLabel6.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(0, 0, 0));
        jLabel6.setText("flexibility and precision. Unlock new levels of technical creativity and");

        jLabel7.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(0, 0, 0));
        jLabel7.setText("benefits of active filter setups over passive ones, such as increased");

        jLabel8.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(0, 0, 0));
        jLabel8.setText("frequency responses, and their dynamic design principles. Discover the");

        jLabel9.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(0, 0, 0));
        jLabel9.setText("prowess by delving deeper into signal conditioning and audio processing");

        jLabel10.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(0, 0, 0));
        jLabel10.setText("using active filters.");
    ...
    private void PDFbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PDFbuttonActionPerformed
        ...
        try{
            File file = new File("src/main/java/Library_PDFfiles/Lesson11.pdf");
            if(file.exists()){
