...
public class Lesson10 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        PDFbutton.setBackground(new java.awt.Color(84, 127, 198));
        ...
        PDFbutton.setText("Learn about Passive Filters!");
        ...
        jLabel1.setText("Passive Filters");
        jLabel1.setIconTextGap(10);

        jPanel2.setBackground(new java.awt.Color(236, 234, 248));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/libraryIcons/11.png"))); // NOI18N
        ...
        jLabel3.setText("Explore the world of passive filters, where signal processing intricacy and");

        jLabel4.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(0, 0, 0));
        jLabel4.setText("passive component simplicity collide. Discover the fundamentals of");

        jLabel5.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 0, 0));
        jLabel5.setText("passive filter design and how inductors, capacitors, and resistors affect a");

        jLabel6.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(0, 0, 0));
        jLabel6.setText("pass and higher. Discover the subtleties of passive filter design through");

        jLabel7.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(0, 0, 0));
        jLabel7.setText("according to their frequency properties, ranging from low-pass to high-");

        jLabel8.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(0, 0, 0));
        jLabel8.setText("circuit's frequency response. Explore how filters are categorized");

        jLabel9.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(0, 0, 0));
        jLabel9.setText("practical experience and theoretical study, and acquire knowledge about");

        jLabel10.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(0, 0, 0));
        jLabel10.setText("their uses in audio processing, signal conditioning, and other fields. Get");

        jLabel11.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(0, 0, 0));
        jLabel11.setText("ready to use passive filters to your advantage in engineering projects so");

        jLabel12.setFont(new java.awt.Font("Istok Web", 0, 12)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(0, 0, 0));
        jLabel12.setText("you may modify signals precisely and elegantly.");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(PDFbutton, javax.swing.GroupLayout.PREFERRED_SIZE, 282, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void PDFbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PDFbuttonActionPerformed
        ...
        try{
            File file = new File("src/main/java/Library_PDFfiles/Lesson10.pdf");
            if(file.exists()){
